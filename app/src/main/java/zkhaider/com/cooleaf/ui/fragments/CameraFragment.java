...
import zkhaider.com.cooleaf.base.BaseEventReportingFragment;
 ...
 */
public abstract class CameraFragment extends BaseEventReportingFragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case GET_FROM_GALLERY:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    mUri = data.getData();
                    mTypedFile = UriHelper.handleUri(mUri, getActivity());
                }
                break;
            default:
    ...
    protected void aspectBitmap() {
        ...
        if (mUri != null) {
            ...
            Toast.makeText(getActivity(), "Image Uri is null", Toast.LENGTH_LONG).show();
        }
    }
