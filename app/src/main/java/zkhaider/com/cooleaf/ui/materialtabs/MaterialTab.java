package zkhaider.com.cooleaf.ui.materialtabs;

/*
VERSION RELEASE CODE: 0.11
 */
...
public class MaterialTab implements View.OnTouchListener {
    ...
    public MaterialTab setText(CharSequence text) {
        if(hasIcon)
            throw new RuntimeException("You have already set this tab with icons, do not input text");
    ...
    private boolean deviceHasRippleSupport() {
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            return false;
        }
        else {
