package zkhaider.com.cooleaf.ui.picassotransformations.jhlabs;
...
import zkhaider.com.cooleaf.ui.picassotransformations.Kernel;
...
public class ConvolveTransformation implements Transformation {
     ...
     */
    public ConvolveTransformation(float[] matrix) {
     ...
     */
    public ConvolveTransformation(int rows, int cols, float[] matrix) {
     ...
     */
    public ConvolveTransformation(Kernel kernel) {
        this.kernel = kernel;
    }
...
//    }
    ...
    @Override
    public String key() {
        // TODO: Build proper key off class fields
        return ConvolveTransformation.class.getCanonicalName();
    }
}